...
class PHPExcel_Shared_Date
{
	...
	//Add start LIXD-155 TinVNIT 9/18/2015
	/**
	 ...
	 */
	public static function getFormatCode(PHPExcel_Cell $pCell)
	{
		$numberFormat = $pCell->getWorksheet()->getStyle($pCell->getCoordinate())->getNumberFormat();
		$formatCode = $numberFormat->getFormatCode();
		
		return $formatCode;
	}
	//Add end LIXD-155 TinVNIT 9/18/2015
	/**
