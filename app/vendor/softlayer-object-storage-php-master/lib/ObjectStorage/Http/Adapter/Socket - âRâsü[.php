...
echo __LINE__ . ' : ' . microtime(true) . '<br />';
...
echo __LINE__ . ' : ' . microtime(true) . 'UPLOAD START <br />';
...
echo __LINE__ . ' : ' . microtime(true) . 'UPLOAD END ROOT A<br />';
            } else if ($this->body != '') {
                fputs($socket, $this->body);
echo __LINE__ . ' : ' . microtime(true) . 'UPLOAD END ROOT B<br />';
            }
        }
